...
class Repeat(nn.Module):
	def __init__(self, num_class):
		...
		self.conv1 = nn.Conv2d(128 + num_class, 128, kernel_size = 7, padding =3)
...
class OpenPose_CPM(nn.Module):
	def __init__(self, num_class):
		...
		self.stage2 = Repeat(num_class)
		self.stage3 = Repeat(num_class)
		self.stage4 = Repeat(num_class)
		self.stage5 = Repeat(num_class)
		self.stage6 = Repeat(num_class)

		
		self.thumb  = Repeat(4)
		self.index  = Repeat(4)
		self.middle = Repeat(4)
		self.ring   = Repeat(4)
		self.pinky  = Repeat(4)
...
def openpose_face(num_classes = 71, **kwargs):
	return OpenPose_CPM(num_classes)

def openpose_hand(num_classes = 22, **kwargs):
	return OpenPose_CPM(num_classes)
